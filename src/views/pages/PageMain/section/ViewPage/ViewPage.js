            ...
            <Layout.Content>
                ...
                <div className={cx("tags")} >
                    ...
                    <div className={cx("list")}>
                        {["고백썰", "이별장소", "강남역"].map(el => <Hash>{el}</Hash>)}
                    </div>
                </div>
                <div className={cx("locationList")} >
                    <h5 className={cx("title")} ><span className={cx("color")} >인기있는 장소</span>는 어디인가요?</h5>
                    <div className={cx("list")}>
                ...
                <div className={cx("ssulList")} >
                    <div className={cx("header")}>
                        <div className={cx("title")} >
                            <i className={cx("logo")} />
                            <h5 className={cx("text")} >의 <span className={cx("color")} >인기썰</span>이 궁금해요</h5>
                        </div>
                        <span className={cx("more")} onClick={handleClickMoreSsul}>더보기</span>
                        </div>
                    <div className={cx("list")}>
                        {locationList.map(el => (
